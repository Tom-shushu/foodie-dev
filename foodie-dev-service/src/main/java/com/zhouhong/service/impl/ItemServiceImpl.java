...
import com.zhouhong.enums.CommentLevel;
import com.zhouhong.mapper.*;
import com.zhouhong.pojo.*;
...
import com.zhouhong.utils.DesensitizationUtil;
...
public class ItemServiceImpl implements ItemService {
    ...
    public List<ItemsSpec> queryItemSpecList(String itemId) {
        ...
        Example itemsSpesExp = new Example(ItemsSpec.class);
        Example.Criteria criteria = itemsSpesExp.createCriteria();
        criteria.andEqualTo("itemId",itemId);

        return itemsSpecMapper.selectByExample(itemsSpesExp);
    }
